    ...
    if login_button:
        if email and password:
            ...
            if user and bcrypt.checkpw(password.encode(), user[2].encode()):
                ...
                error_placeholder.markdown('<p class="error-message">Invalid Email or password</p>', unsafe_allow_html=True)
        else:
            error_placeholder.markdown('<p class="error-message">Please enter both Email and password</p>', unsafe_allow_html=True)
